...
namespace ge::Images {
  ...
  inline void createImage(const std::shared_ptr<LogicalDevice>& logicalDevice,
                                    ...
                                    const uint32_t layerCount)
  {
    ...
    {
      // For external Android Hardware Buffer images
      barrier.srcAccessMask = 0;
      barrier.dstAccessMask = VK_ACCESS_SHADER_READ_BIT;
