...
namespace ge {
  ...
  void Framebuffer::createDepthResources(const VkCommandPool& commandPool,
                                         ...
                                         VkExtent2D extent)
  {
    ...
    m_depthImageView = Images::createImageView(
      m_logicalDevice,
      m_depthImage,
      depthFormat,
  ...
  void Framebuffer::createColorResources(VkExtent2D extent)
  {
    ...
    m_colorImageView = Images::createImageView(
      m_logicalDevice,
      m_colorImage,
      colorFormat,
  ...
  void Framebuffer::createFrameBuffers(const VkRenderPass& renderPass, VkExtent2D extent)
  {
