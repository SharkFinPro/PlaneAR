...
//    external fun fill(rgb: Int, a: Int = 255)
    ...
    external fun translate(x: Float, y: Float)
    external fun scale(x: Float, y: Float)
    external fun scale(xy: Float)
    external fun pushMatrix()
    external fun popMatrix()
    external fun resetMatrix()

//    external fun rectMode(mode: Int)
//    external fun ellipseMode(mode: Int)
//    external fun imageMode(mode: Int)

    external fun rect(x: Float, y: Float, width: Float, height: Float)
    external fun triangle(x1: Float, y1: Float, x2: Float, y2: Float, x3: Float, y3: Float)
...
//    external fun textAlign(alignH: Int, alignV: Int)
